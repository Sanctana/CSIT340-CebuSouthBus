        ...
        <div className="aboutusInnerContainer">
            ...
            <div className="aboutusOuterContainer1">
                ...
                <div className="pContainer">
                    <p>Cebu South Bus is a transportation information and <br />
                booking platform created to simplify travel across <br />
                Southern Cebu. We aim to give our passengers <br />
                a convenient experience by providing updated <br />
                routes, schedules, and easy online booking.<br /></p>
                
                    <p>Whether you're traveling for work, school, <br />
                leisure, or visiting family, we are here to make <br />
                every journey comfortable and hassle-free.</p>
                </div>
            </div>
            ...
            <div className="mission">
                ...
                <p className="pMission">
                    To provide safe, reliable, and affordable<br />
                    transportation while connecting<br />
                    communities across Southern Cebu<br />
            ...
            <div className="vision">
                ...
                <p className="pVision">
                    ...
                    platform for Southern Ceby by making every<br />
