...
function instrumentHandler(handler, fns) {
	...
	if (aggregated.request.length > 0) instrumentedHandler = async (...args) => {
		...
		return throwOrReturnResult(await recurseRight(aggregated.request, {
			...
			invariant$2(result.value instanceof Response, "Expected a Response from the request handler");
			return {
				...getInstrumentationInnerResult(result),
...
async function recurseRight(impls, info, handler, getInnerResult, state = {
	...
	if (!impl) {
		...
		let callHandler = async () => {
			...
			invariant$2(state.innerResult, "Expected an inner result");
...
function createRoutesFromChildren(children, parentPath = []) {
	...
	import_react.Children.forEach(children, (element, index) => {
		...
		invariant$2(!props.index || !props.children, "An index route cannot have child routes.");
		let route = {
...
function getTurboStreamSingleFetchDataStrategy(getRouter, manifest, routeModules, ssr) {
	let dataStrategy = getSingleFetchDataStrategyImpl(getRouter, (match) => {
		...
		invariant$1(manifestRoute, "Route not found in manifest");
		return {
...
async function fetchAndDecodeViaTurboStream(args, targetRoutes) {
	...
	try {
		...
		if (request.method === "GET") {
			...
			invariant$1(routeId, "No routeId found for single fetch call decoding");
		...
		if (routeModule) {
			...
			dataRoute.lazy = {
				...
				middleware: route.hasClientMiddleware ? async () => {
					...
					invariant$1(clientMiddleware, "No `clientMiddleware` export found");
...
*/
//#endregion
export { createClientRoutes as $, AwaitContextProvider as $t, createBrowserRouter as A, createHashHistory as An, useActionData as At, useSubmit as B, useNavigate as Bt, BrowserRouter as C, matchRoutes as Cn, createRoutesFromChildren as Ct, Link as D, resolvePath as Dn, withComponentProps as Dt, HistoryRouter as E, replace as En, renderMatches as Et, useFormAction as F, PROTOCOL_RELATIVE_URL_REGEX as Fn, useInRouterContext as Ft, Links as G, useParams as Gt, RemixErrorBoundary as H, useNavigationType as Ht, useLinkClickHandler as I, useLoaderData as It, Scripts as J, useRoute as Jt, Meta as K, useResolvedPath as Kt, usePrompt as L, useLocation as Lt, useBeforeUnload as M, createPath as Mn, useAsyncValue as Mt, useFetcher as N, invariant$2 as Nn, useBlocker as Nt, NavLink as O, Action as On, withErrorBoundaryProps as Ot, useFetchers as P, parsePath as Pn, useHref as Pt, useFogOFWarDiscovery as Q, useRoutes as Qt, useScrollRestoration as R, useMatch as Rt, createStaticRouter as S, matchPath as Sn, createMemoryRouter as St, HashRouter as T, redirectDocument as Tn, hydrationRouteProperties as Tt, CRITICAL_CSS_DATA_ATTRIBUTE as U, useOutlet as Ut, useViewTransitionState as V, useNavigation as Vt, FrameworkContext as W, useOutletContext as Wt, getPatchRoutesOnNavigationFunction as X, useRouteLoaderData as Xt, setIsHydrated as Y, useRouteError as Yt, getPathsWithAncestors as Z, useRouterState as Zt, isCookie as _, createContext as _n, RouterProvider as _t, RSCDefaultRootErrorBoundary as a, RSCRouterContext as an, getSingleFetchDataStrategyImpl as at, StaticRouter as b, generatePath as bn, WithErrorBoundaryProps as bt, createMemorySessionStorage as c, IDLE_BLOCKER as cn, stripIndexParam as ct, createSessionStorage as d, createRouter as dn, Await as dt, DataRouterContext as en, createClientRoutesWithHMRRevalidationOptOut as et, isSession as f, createStaticHandler as fn, MemoryRouter as ft, createCookie as g, RouterContextProvider as gn, Router as gt, ServerMode as h, ErrorResponseImpl as hn, Route as ht, populateRSCRouteModules as i, NavigationContext as in, decodeViaTurboStream as it, createHashRouter as j, createMemoryHistory as jn, useAsyncError as jt, ScrollRestoration as k, createBrowserHistory as kn, withHydrateFallbackProps as kt, createCookieSessionStorage as l, IDLE_FETCHER as ln, createRequestInit as lt, setDevServerHooks as m, isMutationMethod as mn, Outlet as mt, RSCStaticRouter as n, FetchersContext as nn, shouldHydrateRouteLoader as nt, RSCRouterGlobalErrorBoundary as o, RouteContext as on, getTurboStreamSingleFetchDataStrategy as ot, createRequestHandler as p, hasInvalidProtocol as pn, Navigate as pt, PrefetchPageLinks as q, useRevalidator as qt, routeRSCServerRequest as r, LocationContext as rn, SingleFetchRedirectSymbol as rt, href as s, ViewTransitionContext as sn, singleFetchUrl as st, getHydrationData as t, DataRouterStateContext as tn, noActionDefinedError as tt, createSession as u, IDLE_NAVIGATION as un, createSearchParams as ut, createRoutesStub as v, data as vn, Routes as vt, Form as w, redirect as wn, createRoutesFromElements as wt, StaticRouterProvider as x, isRouteErrorResponse as xn, WithHydrateFallbackProps as xt, ServerRouter as y, defaultMapRouteProperties as yn, WithComponentProps as yt, useSearchParams as z, useMatches as zt };
