...
import { $ as createClientRoutes, Dn as resolvePath, Fn as PROTOCOL_RELATIVE_URL_REGEX, H as RemixErrorBoundary, Nn as invariant, Q as useFogOFWarDiscovery, Tt as hydrationRouteProperties, U as CRITICAL_CSS_DATA_ATTRIBUTE, W as FrameworkContext, X as getPatchRoutesOnNavigationFunction, Y as setIsHydrated, Z as getPathsWithAncestors, _n as createContext, _t as RouterProvider, an as RSCRouterContext, at as getSingleFetchDataStrategyImpl, ct as stripIndexParam, dn as createRouter, et as createClientRoutesWithHMRRevalidationOptOut, hn as ErrorResponseImpl, i as populateRSCRouteModules, it as decodeViaTurboStream, kn as createBrowserHistory, lt as createRequestInit, mn as isMutationMethod, nt as shouldHydrateRouteLoader, o as RSCRouterGlobalErrorBoundary, ot as getTurboStreamSingleFetchDataStrategy, pn as hasInvalidProtocol, st as singleFetchUrl, t as getHydrationData, tt as noActionDefinedError, yn as defaultMapRouteProperties } from "./development-Du3CWU_F.js";
//#region node_modules/react-router/dist/development/lib/dom-export/dom-router-provider.js
...
//#endregion
//#region node_modules/react-router/dist/development/lib/dom-export/hydrated-router.js
/**
* react-router v8.2.0
*
* Copyright (c) Remix Software Inc.
...
function createHydratedRouter({ getContext, instrumentations }) {
	...
	let router = createRouter({
		...
		instrumentations,
		dataStrategy: getTurboStreamSingleFetchDataStrategy(() => router, ssrInfo.manifest, ssrInfo.routeModules, ssrInfo.context.ssr),
		patchRoutesOnNavigation: getPatchRoutesOnNavigationFunction(() => router, ssrInfo.manifest, ssrInfo.routeModules, ssrInfo.context.ssr, ssrInfo.context.routeDiscovery, ssrInfo.context.isSpaMode, ssrInfo.context.basename)
	});
...
function HydratedRouter(props) {
	...
	} }, /* @__PURE__ */ import_react.createElement(RemixErrorBoundary, { location }, /* @__PURE__ */ import_react.createElement(RouterProvider$1, {
		router,
...
//#endregion
//#region node_modules/react-router/dist/development/lib/rsc/browser.js
/**
* react-router v8.2.0
*
* Copyright (c) Remix Software Inc.
...
function RSCHydratedRouter({ createFromReadableStream, fetch: fetchImplementation = fetch, payload, getContext }) {
	...
	let { router, routeModules } = import_react.useMemo(() => createRouterFromPayload({
		payload,
		fetchImplementation,
		getContext,
		createFromReadableStream
	...
	import_react.useLayoutEffect(() => router.subscribe((newState) => {
		if (diffRoutes(router.routes, routes)) import_react.startTransition(() => {
			setState({
				routes: cloneRoutes(router.routes),
				state: newState
			});
...
//#endregion
//#region node_modules/react-router/dist/development/lib/rsc/html-stream/browser.js
/**
* react-router v8.2.0
*
* Copyright (c) Remix Software Inc.
...
*/
//#endregion
export { HydratedRouter, RouterProvider$1 as RouterProvider, RSCHydratedRouter as unstable_RSCHydratedRouter, createCallServer as unstable_createCallServer, getRSCStream as unstable_getRSCStream };
