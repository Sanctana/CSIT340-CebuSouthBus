        ...
        {contactInfo.map((item) => (
          <div className="contact-card" key={item.id}>
            <div className="contact-icon-box">
              <img src={item.icon} alt={item.label} className="contact-image" />
            </div>
            ...
            <div className="contact-link-list">
              <a href="tel:+6354645655" className="contact-link-item">
                <div className="contact-icon-box contact-icon-box--lg">
                  <img src={phoneLogo} alt="Phone" className="contact-image" />
                </div>
              ...
              >
                <div className="contact-icon-box contact-icon-box--lg">
                  <img src={emailLogo} alt="Email" className="contact-image" />
                </div>
