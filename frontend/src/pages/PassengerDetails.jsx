...
export default function PassengerDetails() {
    ...
    const validate = () => {
        ...
        if (!/^09\d{9}$/.test(contact.mobile)) {
            newErrors.mobile = "Enter a valid 11-digit mobile number (e.g. 09171234567).";
        }
        ...
        <div className="passenger-page">
            ...
            <div className="passenger-main">
                ...
                <section className="form-card">
                    ...
                    <p className="hint">We'll send your e-ticket and trip updates here.</p>
                ...
                <section className="form-card">
                    ...
                    <p className="hint">Enter each passenger's details exactly as shown on a valid ID.</p>
                ...
                <label className="agree-row">
                    ...
                    />
                    I confirm the passenger details above are accurate and match a valid ID.
                </label>
