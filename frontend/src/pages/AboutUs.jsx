  ...
  return (
      <div className="aboutusPage">
        ...
        <div className="aboutusHero">
          ...
          <h1>Who We Are</h1>
          <p>
            A transportation platform created to simplify travel across Southern Cebu —
        ...
        <div className="aboutusContent">
          ...
          <div className="aboutTop">
            <div className="aboutusTextCol">
              <p className="aboutusBody">
                Cebu South Bus is a transportation information and booking platform
                created to simplify travel across Southern Cebu. We aim to give our
                passengers a convenient experience by providing updated routes,
                schedules, and easy online booking.
              </p>
              <p className="aboutusBody">
            ...
            <div className="aboutRight">
              <img src={heroPhoto} alt="Scenic road in Southern Cebu" className="aboutusPhoto" />
            </div>
          </div>
          ...
          <div className="aboutBottom">
            ...
            <div className="vision">
              ...
              <p className="pVision">
                ...
                Cebu by making every journey easier, safer, and more accessible for
                all passengers.
              </p>
            </div>
          </div>
          ...
          <div className="whySection">
            <h2>Why Choose Us?</h2>
            <p className="whySub">Trusted by thousands of passengers across Southern Cebu every day.</p>
