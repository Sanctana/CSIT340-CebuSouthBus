    ...
    return (
        <div className="confirmation-page">
          <div className="confirmation-empty">
            ...
            <p>
              We couldn't find a confirmed booking to show. If you already have
              a confirmation code, use "Manage Booking" on the homepage to look
              it up.
            </p>
      ...
      <div className="confirmation-page">
        ...
        <div className="confirmation-main">
          ...
          <section className="review-card">
            <h2>Payment</h2>
            <p className="payment-summary">
              Paid via <strong>{paymentLabels[paymentMethod] ?? paymentMethod}</strong>
            </p>
          </section>
